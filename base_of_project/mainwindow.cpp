...
#include "max_circle_inside_nonconvex_polygon/max_circle_inside_nonconvex_polygon.h"
...
void MainWindow::on_tipAlgoritma_currentIndexChanged(int index)
{
    ...
    else
    {
        ...
        if (tipAlgoritma == TipAlgoritma::MAX_KRUG_PROSTOG_POLIGONA)
        {
            ui->Nasumicni_dugme->setEnabled(false);
            ui->merenjeButton->setEnabled(false);
        }
...
void MainWindow::napraviNoviAlgoritam()
{
    ...
    case TipAlgoritma::_3D_ISCRTAVANJE:
        ...
        break;
    */
    case TipAlgoritma::MAX_KRUG_PROSTOG_POLIGONA:
        _pAlgoritamBaza = new MaxKrugProstogPoligona(_pOblastCrtanja, _duzinaPauze, _naivni,
                                              _imeDatoteke, _brojSlucajnihObjekata);
        break;
